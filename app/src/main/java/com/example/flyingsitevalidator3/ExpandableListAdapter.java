...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        ListItem li = (ListItem) getChild(groupPosition, childPosition);
        final String childTitle = li.getTitle();
        final String childText = li.getContent();
        ...
        txtListChildTitle.setText(childTitle);
